...
def load_xlmt_model_ensemble(
    ...
    from fairseq.models.two_stage_sparse_transformer import TwoStageSparseModel
    ...
    for filename in filenames:
        ...
        for shard_idx in range(num_shards):
            ...
            cfg.model.pretrained_infoxlm_checkpoint = ""
            if model_type == "two-stage":
                model = TwoStageSparseModel.build_model_without_task(cfg.model, src_dict, tgt_dict)
            else:
...
def expand_embedding_matrix(state, model):
